...
class GameViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.videoGames = [
            VideoGame(title: "Assassin's Creed", mainCharacter: "Altaïr ibn-La'Ahad", leadImage: "assassins_creed.png", bodyCopy: "Desmond Miles, a bartender, is kidnapped by Abstergo Industries. There, Desmond is forced to interface with the Animus, a device that is able to replay the genetic memories of the user's ancestors. In Desmond's case, they seek information about his ancestor Altaïr Ibn-La'Ahad, an Assassin during the time of the Third Crusade."),
